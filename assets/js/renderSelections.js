$("body").ready(function () {
    ...
    for (let i = 0; i < size; i++) {
        ...
        <p>${foodObj[i][0]}</p>
        <button class="foodRemover remover close" type="button" data-index=${i}>&times;</button>`)); // adds a "remove" button
    }
    ...
    for (let i = 0; i < length; i++) {
        ...
        <p>${drinksObj[i][0]}</p>
        <button class="drinksRemover remover close" type="button" data-index=${i}>&times;</button>`)); // adds a "remove" button
    }
